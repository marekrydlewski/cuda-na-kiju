...
Blablaba mierzyliśmy wydajność w zależności od rozmiaru danych, zmiennego progu odległości i powszechności.

\subsubsection{Dane wejściowe}

Dane wygenerowaliśmy przy pomocy generatora, do testów od rozmiaru danych utworzyliśmy 8 (7?) instancji od których rozmiary w przedziale około 3000-200000 punktów. Staraliśmy się zachować przy tym podobny rozkład cech itp itd. Do testów odległości wygenerowaliśmy 4 instancje - rzadka i gęsta oraz rzadka i gęsta z "hotspotami". Powszechność - rzadka i gęsta. Wszystko 1000x1000 punktów.

\subsubsection{Sprzęt}

2 TITANY FULL IMBA + opis sprzętu
