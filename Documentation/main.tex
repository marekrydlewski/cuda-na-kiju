...
%acknowledgement
\newgeometry{left=8cm, textwidth=11.5cm}
\thispagestyle{empty}
$\mbox{ }$
\vfill\vfill
\hfill
...
\begin{em}
 ...
 do naszego promotora dr inż. Witolda Andrzejewskiego
\end{em}
\pagebreak
\restoregeometry
...
\draw[draw=black!30,latex-] (0,3) +(0,0.5cm) node[above left] {\footnotesize $y$} -- (0,0) -- +(0, 0cm);
\draw[draw=black!30,-latex] (0,0) +(0cm,0) -- (3,0) -- +(0.5cm,0) node[below right] {\footnotesize $x$};
...
\Output{ $ out $ - wynik porównania }
\myproc{\proc{a, b}}{
$ out \leftarrow (featureId_{a_{0}} = featureId_{b_{0}}) \wedge (featureId_{a_{1}} = featureId_{b_{1}})$\;
}
...
\Output{ $ out $ - wynik porównania }
\myproc{\proc{a, b}}{
$ out \leftarrow (field_{a_{0}} = field_{b_{0}}) \wedge (featureId_{a_{1}} = featureId_{b_{1}})$\;
}
\caption{Operator równości dla par instancji typu \textit{FeatureInstanceTuple}}
...
\bibitem{cuda_dp}Adinetz A., \textit{CUDA Dynamic Parallelism API and Principles (NVIDIA Developer Blogs)}, 20-04-2014 [dostęp: 10-01-2017]. Dostępny w Internecie: https://devblogs.nvidia.com/parallelforall/cuda-dynamic-parallelism-api-principles
\bibitem{asoc}Agrawal R., Srikant R., \textit{Fast Algorithms for Mining Association Rules in Large Databases.} W: \textit{Proceedings of the 20th International Conference on Very Large Data Bases (VLDB 1994)}, USA, 1994, strony 487–499.
\bibitem{hashmap}Alcantara D. A. F., \textit{Efficient Hash Tables on the GPU}, Davis, 2011.
\bibitem{plane}Andrzejewski W., Boiński P., \textit{Parallel GPU-based Plane-Sweep Algorithm for Construction of iCPI-Trees.} W: Journal of Database Management nr 26(3), USA, 2015, strony 1-20.
\bibitem{plane2}Andrzejewski W., Boiński P., \textit{ICPI Tree construction parallelization on Graphics Processing Units
(Technical Report RA-012/2014)}, Poznań, 2014.
\bibitem{spatial}Arge L., Procopiuc O., Ramaswamy S., Suel T., Vitter J., \textit{Scalable Sweeping-Based Spatial Join.} W: \textit{Proceedings of the International Conference on Very Large Databases (VLDB 1998)}, USA, 1998.
\bibitem{belman}Bellman R. E., \textit{Adaptive Control Processes - A Guided Tour}, USA, 1961.
\bibitem{boinski}Boiński P., \textit{Przetwarzanie zbiorów przestrzennych zapytań eksploracyjnych w środowiskach z ograniczonym rozmiarem pamięci operacyjnej}, Poznań, 2015.
\bibitem{kerbosz}Bron C., Kerbosch J. \textit{Algorithm 457: Finding all cliques of an undirected graph.} W: \textit{Communications of the ACM nr 16}, USA, 1973, strony 575–577.
\bibitem{pivot2}Cazals F., Karande C., \textit{A note on the problem of reporting maximal cliques.} W:\textit{ Theoretical Computer Science nr 407}, USA, 2008, strony 564–568.
\bibitem{professional_cuda}Cheng J., Grossman M., McKerche T., \textit{Professional CUDA C Programming}, Wrox, 2014.
\bibitem{9sec2}Clementini E., Di Felice P., van Oosterom P., \textit{A small set of formal topological relationships suitable for end-user interaction.} W: \textit{Proceedings of the 3rd International Symposium on Advances in Spatial Databases (SSD 1993)}, Wielka Brytania, 1993, strony 277-295.
\bibitem{9sec}Egenhofer M. J., \textit{Franzosa R. Point-set topological spatial relations.} W: \textit{International Journal of Geographic Information Systems nr 5}, 1991, strony 161–174.
\bibitem{degenerat}Eppstein D., Löffler M., Strash D., \textit{Listing all maximal cliques in sparsegraphs in near-optimal time}. W: \textit{21st International Symposium On Algorithms And Computation}, Niemcy, 2010, strony 403–414.
\bibitem{toptrendy}Ester M., Frommelt A., Kriegel H. P., Sander J., \textit{Algorithms for characterization and trend detection in spatial databases.} W: \textit{Proceedings of the 4th International Conference on Knowledge Discovery and Data Mining (KDD 1998)}, USA, 1998, strony 44–50.
\bibitem{klasyfikacja}Ester M., Kriegel H. P., Sander J.,\textit{ Spatial Data Mining: A Database Approach.} W:\textit{ In Proceedings of the 5th International Symposium on Advances in Spatial Databases (SSD 1997)}, Wielka Brytania, 1997, strony 47–66.
\bibitem{kdd}Fayyad U., Piatetsky-Shapiro G., Smyth P., \textit{From Data Mining to Knowledge Discovery in Databases.} W: \textit{AI Magazine nr 17}, 1996, strony 37-54.
\bibitem{cuda_um}Harris M., \textit{Unified Memory in CUDA 6 (NVIDIA Developer Blogs)}, 18-11-2013 [dostęp: 10-01-2017]. Dostępny w Internecie: https://devblogs.nvidia.com/parallelforall/unified-memory-in-cuda-6
\bibitem{fieldmodel}Jones C., Hall M., \textit{A Field Based Representation for Vague Areas Defined by Spatial Prepositions.} W: \textit{Proceedings of the Workshop on Methodologies and Resources for Processing Spatial Language at 6th Language Resources and Evaluation Conference (LREC 2008)}, Maroko, 2008.
\bibitem{asoc2}Koperski K., Han J., \textit{Discovery of Spatial Association Rules in Geographic Information Databases.} W: \textit{Proceedings of the 4th International Symposium on Advances in Spatial Databases (SSD 1995) nr 951}, USA, 1995, strony 47–66.
\bibitem{matusiak}Matula D. W., Beck L. L., \textit{Smallest-last ordering and clustering and graph coloring algorithms.} W: \textit{Journal of the ACM nr 30}, USA, 1983, strony 417–427.
\bibitem{trad}Miller H. J., Han J., \textit{Geographic Data Mining and Knowledge Discovery}, Bristol, USA, 2001.
\bibitem{classsets}Morimoto Y., \textit{Mining Frequent Neighboring Class Sets in Spatial Databases.} W: \textit{Proceedings of the 7th ACM SIGKDD International Conference on Knowledge Discovery and Data Mining (KDD 2001)}, USA, 2001, strony 353–358.
\bibitem{mikromiekki}Praca zbiorowa, \textit{Comparing the Concurrency Runtime to Other Concurrency Models (Microsoft)}, 2015 [dostęp: 10-01-2017]. Dostępny w Internecie: https://msdn.microsoft.com/en-us/library/dd998048.aspx\#openmp
\bibitem{stak}Praca zbiorowa, \textit{Microsoft Parallel Patterns Library (PPL) vs. OpenMP (Stack Overflow)}, 14-03-2012 [dostęp: 10-01-2017]. Dostępny w Internecie: http://stackoverflow.com/questions/9700088/microsoft-parallel-patterns-library-ppl-vs-openmp
\bibitem{id3}Quinlan J. R., \textit{Induction of Decision Trees.} W: \textit{Machine Learning nr 1}, USA, 1986, strony 81–106.
\bibitem{trad2}Roddick J. F., Spiliopoulou M., \textit{A Bibliography of Temporal, Spatial and Spatio-Temporal data Mining Research.} W: \textit{ACM SIGKDD Exploration Newsletter nr 1}, USA, 1999, strony 34–38.
\bibitem{cuda_by_examples}Sanders J., Kandrot E., \textit{CUDA by Example: An Introduction to General-Purpose GPU Programming}, Addison-Wesley, 2011.
\bibitem{przypadeg}Shekhar S., Chawla S., \textit{Spatial Databases: A Tour}, USA, 2003.
\bibitem{huang}Shekhar S., Huang Y., \textit{Discovering Spatial Co-location Patterns: A Summary of Results}. W: \textit{SSTD}, 2001, strony 236–256.
\bibitem{multihuang}Shekhar S., Huang Y., \textit{The Multi-resolution Co-location Miner: A New Algorithm to Find Co-location Patterns in Spatial Dataset}. W: \textit{Technical Report 02-019}, USA, 2002.
\bibitem{pivot}Tomita E., Tanaka A., Takahashi H., \textit{The worst-case time complexity for generating all maximal cliques and computational experiments.} W: \textit{Theoretical Computer Science nr 363}, USA, 2006, strony 28–42.
\bibitem{buffered-sort}Vinodsu, \textit{Sorting in PPL, Parallel Programming in Native Code (Microsoft Developer Network Blogs)}, 14-01-2011 [dostęp: 10-01-2017]. Dostępny w Internecie: https://blogs.msdn.microsoft.com/nativeconcurrency/2011/01/14/sorting-in-ppl/
\bibitem{icpi}Wang L., Bao Y., Lu J., \textit{Efficient Discovery of Spatial Co-Location Patterns Using the iCPI-tree.} W: \textit{The Open Information Systems Journal nr 3}, 2009, strony 69–80.
\bibitem{cpi}Wang L., Bao Y., Lu J., Yip J., \textit{A New Join-less Approach for Co-location Pattern Mining.} W: \textit{Proceedings of the 8th IEEE International Conference on Computer and Information Technology (CIT 2008)}, Sydney, 2008, strony 197–202.
\bibitem{wang}Wang L., Zhou L., Lu J., Yip J., \textit{An order-clique-based approach for mining maximal co-locations.} W: \textit{Information Sciences nr 179}, USA, 2009, strony 3370–3382.
\bibitem{chinczyki}Yao X., Peng L., Yang L., Chi T.,\textit{ A fast space-saving algorithm for maximal co-location pattern mining.} W: \textit{Expert Systems with Applications nr 63}, 2016, strony 310–323.
\bibitem{joinless}Yoo J. S., Shekhar S., \textit{A Joinless Approach for Mining Spatial Colocation Patterns.} W: \textit{IEEE Transactions on Knowledge and Data Engineering}, USA, 2006.
\end{thebibliography}
