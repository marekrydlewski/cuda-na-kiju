...
\bibitem{trad} Miller H. J., Han J. Geographic Data Mining and Knowledge Discovery.
Bristol, USA, 2001.
...
\bibitem{cpi}Wang L., Bao Y., Lu J., Yip J. A New Join-less Approach for Co-location Pattern Mining. W: Proceedings of the 8th IEEE International
...
\bibitem{spatial}Arge L., Procopiuc O., Ramaswamy S., Suel T., Vitter J. Scalable Sweeping-
...
\bibitem{pivot}Tomita E., Tanaka A., Takahashi H. The worst-case time complexity for
...
\bibitem{cuda_um}Unified Memory in CUDA 6, Harris M. (NVIDIA Developer Blogs), 18-11-2013 [dostęp: 10-01-2017]. Dostępny w Internecie: https://devblogs.nvidia.com/parallelforall/unified-memory-in-cuda-6
\bibitem{cuda_dp}CUDA Dynamic Parallelism API and Principles, Adinetz A. (NVIDIA Developer Blogs) [dostęp: 10-01-2017]. Dostępny w Internecie: https://devblogs.nvidia.com/parallelforall/cuda-dynamic-parallelism-api-principles
\end{thebibliography}
