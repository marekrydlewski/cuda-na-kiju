...
Jedyną różnicą na tym etapie algorytmu w stosunku do odmiany sekwencyjnej jest dodatkowy krok określenia zakresu pracy dla każdego z wątków biorących udział w liczeniu wystąpień par instancji. Odpowidzialna za to jest funkcja $ countUniqueInstances $.
...
%jeśli chodzi o równoległy, to jest dość skomplikowana sprawa, najbezpieczniej napisać że przyśpieszenie uzyskuje się poprzez zrównoleglenie pętli
%BK vertex ordering odpala równolegle BK pivoting
%i że takie podejście może wygenrowac duplikaty
%ale i tak jest szybciej bo wincyj rdzeniufff
%i rzutujemy to na seta i dealujemy z tym
%i na końcu jest jeszcze combine_each lokalnych max cliques
