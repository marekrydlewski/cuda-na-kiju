...
Ostatnią czynnością jest posortowanie par instancji przy użyciu następującego operatora\\
...
\subsubsection{Wygenerowanie prewalentnych relacji sądziędztwa pomiędzy typami połączeń}
