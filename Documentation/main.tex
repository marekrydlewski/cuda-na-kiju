...
Oprócz tego multiprocesor wyposażony jest w układy sterujące wywowłaniem instrukcji (ang. \textit{Instruction Dispatch Unit}) odpowiadające za wykonywanie obliczeń na zgrupowanych rdzeniach.
